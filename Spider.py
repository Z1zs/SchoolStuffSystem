...
html_dict = {"院部设置": html_source2, "治理结构": html_source1, "党政部门": html_source3, "直属单位": html_source4,
             "附属单位及直管企业": html_source5}
...
dep_json = json.dumps(dep_dict,sort_keys=False, indent=4, separators=(',', ': '))
f = open('dep.json', 'w')
f.write(dep_json)
